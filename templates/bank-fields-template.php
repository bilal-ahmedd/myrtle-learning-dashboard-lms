<img src="<?php echo MLD_ASSETS_URL.'images/form-header.PNG'; ?>" style="width: 100%;">
<div class="mld-personal-bank-detail-wrapper">
		...
		<div class="mld-personal-detail-wrapper">
			<div class="mld-pd-row1">
				<div class="mld-pd-title-wrapper">
					...
					<div class="mld-pd-title-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-pd-forename-wrapper">
					...
					<div class="mld-pd-forename-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-pd-surname-wrapper">
					<div class="mld-pd-surname mld-padding"><?php echo __( 'Surname', 'myrtle-learning-dashboard' ); ?></div>
					<div class="mld-pd-surname-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-pd-row2">
				<div class="mld-pd-ni-number-wrapper">
					...
					<div class="mld-pd-ni-number-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-pd-dob-wrapper">
					<div class="mld-pd-dob mld-padding"><?php echo __( 'Date of Birth', 'myrtle-learning-dashboard' ); ?></div>
					<div class="mld-pd-dob-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-pd-row3">
				<div class="mld-pd-home-address-wrapper">
					...
					<div class="mld-pd-home-address-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-pd-row4">
				<div class="mld-pd-home-email-wrapper">
					...
					<div class="mld-pd-home-email-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-pd-mobile-number-wrapper">
					...
					<div class="mld-pd-mobile-number-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-pd-row5">
				<div class="mld-pd-subjects-wrapper">
					...
					<div class="mld-pd-subjects-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="mld-bank-detail-wrapper">
			...
			<div class="mld-bank-detail-row1">
				<div class="mld-bd-b-name-wrapper">
					...
					<div class="mld-bd-name-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-bd-b-account-name-wrapper">
					...
					<div class="mld-bd-account-name-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-bank-detail-row2">
				<div class="mld-bd-sort-code-wrapper">
					...
					<div class="mld-bd-sort-code-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-bd-b-account-number-wrapper">
					...
					<div class="mld-bd-b-account-number-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-bank-detail-row3">
				<div class="mld-bd-bank-address-wrapper">
					...
					<div class="mld-bd-bank-address-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="mld-disclosure-service-wrapper">
			...
			<div class="mld-disclosure-service-row1">
				<div class="mld-certificate-number-wrapper">
					...
					<div class="mld-certificate-number-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-certificate-surname-wrapper">
					...
					<div class="mld-certificate-surname-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-disclosure-service-row2">
				<div class="mld-current-yn-wrapper">
					...
					<div class="mld-current-yn-data mld-padding" contenteditable="true"></div>
				</div>
				<div class="mld-certificate-dob-wrapper">
					...
					<div class="mld-certificate-dob-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
			<div class="mld-disclosure-service-row3">
				<div class="mld-internal-use-wrapper">
					...
					<div class="mld-internal-use-data mld-padding" contenteditable="true"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="mld-signature-wrapper">
		...
		<table border="2px" class="mld-signature-table">
			...
			<tr>
				<td contenteditable="true" class="mld-signatur-name"></td>
				...
				<td contenteditable="true" class="mld-signature-date">
					<?php
					if( ! is_admin() ) {
						?>
						<input type="date">
	...
	<div class="mld-submit-wrapper">
		<input type="button" class="mld-bank-detail-submit-btn" value="<?php echo __( 'Submit', 'myrtle-learning-dashboard' ); ?>">
		<div class="mld-error-msg">
			<?php echo __( 'You have already submitted this form earlier.' ); ?>
		</div>
	</div>
</div>